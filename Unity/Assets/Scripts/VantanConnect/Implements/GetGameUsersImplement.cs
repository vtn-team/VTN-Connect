...
/// </summary>
public class GetGameUsersImplement
{
    /// <summary>
    /// 現在のゲーム参加情報取得
    /// </summary>
    ...
    {
        string request = String.Format("{0}/gameusers/active", ProjectSettings.APIServerURI);
    ...
    {
        string request = String.Format("{0}/gameusers/{1}", ProjectSettings.APIServerURI, gameHash);
        string json = await Network.WebRequest.GetRequest(request);
